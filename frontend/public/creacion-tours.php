    ...
    <div class="container" >
        <div class="row">
         ...
         <div class="col-12">
            ...
            <input id="create-noches"class="form-control" type="text" placeholder="Nombre del Tour">
        </p>
        <p>
            <label>Fecha de Inicio</label><br>
            <input id="create-noches"class="form-control" type="date" placeholder="Nombre del Tour">
        </p>
        <p>
            <label>Cupos</label><br>
            <input id="create-noches"class="form-control" type="text" placeholder="#Número de Cupos">
        </p>
        <p>
            <label>Tipo Tour</label><br>
                <select id="create-tipotour"class="form-control">
        ...
        <button onclick="location.href = 'creacion-rutas.php'" style="margin-left: 40%;width: 150px;border-color: green;background-color: green !important;" type="button" class="btn btn-success">Crear Tour</button>
</div>
</div></div></div>
