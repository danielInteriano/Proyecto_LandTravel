...
<body>
      ...
      <div class="col-12">
        <div class="box-create">
          ...
          <p>
            ...
            <input id="nombre" class="form-control" type="text" placeholder="Nombre del Tour" value="<?php echo $result_php['tours']['nombre'] ?>">
          </p>
          <p>
            <label>Fecha de Inicio</label><br>
            <input id="fecha-inicio" class="form-control" type="date" value="<?php echo $result_php['tours']['fecha_inicio'] ?>">
          </p>
          <p>
            <label>Cupos</label><br>
            <input id="cupo" class="form-control" type="text" placeholder="#Número de Cupos" value="<?php echo $result_php['tours']['cupo'] ?>">
          </p>
          <p>
            ...
            <select id="tipo-tour" class="form-control">
              ...
              ?>
                <option value="<?php echo $mostrar[0] ?>" <?php if($mostrar[0] == $result_php['tours']['idtipo']) echo 'selected'; ?>><?php echo $mostrar[1] ?> </option>
              <?php
              }
          ...
          <button id="button-create" style="margin-left: 40%;width: 150px;border-color: green;background-color: green !important;" type="button" class="btn btn-success">Actualizar Tour</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="../js/modificar-tours.js"></script>
