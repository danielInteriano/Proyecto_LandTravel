...
final class RespuestaJson extends Response
{
    ...
    public static function NOT_FOUND_DATA(array $data = []): self
    {
    ...
    public static function INTERNAL_ERROR(array $data = []): self
    {
        return new self(500, $data);
    }

    public static function BAD_REQUEST(array $data = []): self
    {
